      ...
      <div className="review">
        <div className="css-820 ">
          ...
          <div className="css-824">
            ...
            <div className="css-825">{generateStar(comment.start)}</div>
          </div>
                ...
                <li class="css-128">
                  ...
                  <div class="css-129">
                    <div
                      ...
                      style={{
                        width: `${
                          (countFeedback(5, listComment.listComment) * 100) /
                  ...
                  <span class="css-130">
                    {countFeedback(5, listComment.listComment)} đánh giá
                  </span>
                </li>
                <li class="css-128">
                  <span class="css-800">
                  ...
                  <div class="css-129">
                    <div
                      ...
                      style={{
                        width: `${
                          (countFeedback(4, listComment.listComment) * 100) /
                            listComment.listComment.length || 0
                        }%`,
                      }}
                    ></div>
                  ...
                  <span class="css-130 have-rating">
                    {countFeedback(4, listComment.listComment)} đánh giá
                  </span>
                </li>
                <li class="css-128">
                  <span class="css-800">
                  ...
                  <div class="css-129">
                    <div
                      ...
                      style={{
                        width: `${
                          (countFeedback(3, listComment.listComment) * 100) /
                            listComment.listComment.length || 0
                        }%`,
                      }}
                    ></div>
                  ...
                  <span class="css-130">
                    {countFeedback(3, listComment.listComment)} đánh giá
                  </span>
                </li>
                <li class="css-128">
                  <span class="css-800">
                  ...
                  <div class="css-129">
                    <div
                      ...
                      style={{
                        width: `${
                          (countFeedback(2, listComment.listComment) * 100) /
                            listComment.listComment.length || 0
                        }%`,
                      }}
                    ></div>
                  ...
                  <span class="css-130">
                    {countFeedback(2, listComment.listComment)} đánh giá
                  </span>
                </li>
                <li class="css-128">
                  <span class="css-800">
                  ...
                  <div class="css-129">
                    <div
                      ...
                      style={{
                        width: `${
                          (countFeedback(1, listComment.listComment) * 100) /
                            listComment.listComment.length || 0
                        }%`,
                      }}
                    ></div>
                  ...
                  <span class="css-130 have-rating">
                    {countFeedback(1, listComment.listComment)} đánh giá
                  </span>
                </li>
              </ul>
            </div>
            <div className="feedback_statistic">
              <h2 className="feedback-statistic-title">ĐÁNH GIÁ TRUNG BÌNH</h2>
              <div className="feedback-statistic-number">
                <span>{countAverageStar(listComment.listComment) || 0}</span>/
                <span>5</span>
              </div>
              <div className="feedback-statistic-star">
                <div class="stars-outer">
                  <div
                    ...
                    style={{
                      width: `${
                        (countAverageStar(listComment.listComment) * 100) / 5
                      }%`,
                    }}
                  ></div>
                </div>
            ...
            <div className="form-group col-12">
              <div className="star_rating">
                <i
                  data-value={1}
                  onClick={onVoteStar}
                  style={comment.VoteStart >= 1 ? { color: "#F6BC3E" } : {}}
                  className="far fa-star"
                ></i>
                <i
                  data-value={2}
                  onClick={onVoteStar}
                  style={comment.VoteStart >= 2 ? { color: "#F6BC3E" } : {}}
                  className="far fa-star"
                ></i>
                <i
                  data-value={3}
                  onClick={onVoteStar}
                  style={comment.VoteStart >= 3 ? { color: "#F6BC3E" } : {}}
                  className="far fa-star"
                ></i>
                <i
                  data-value={4}
                  onClick={onVoteStar}
                  style={comment.VoteStart >= 4 ? { color: "#F6BC3E" } : {}}
                  className="far fa-star"
                ></i>
                <i
                  data-value={5}
                  onClick={onVoteStar}
                  style={comment.VoteStart >= 5 ? { color: "#F6BC3E" } : {}}
                  className="far fa-star"
                ></i>
              </div>
            </div>
          ...
          <div class="comment-question">
            <div class="comment-question__header">
              <div class="comment-question__count">
                {listComment.data == "" || listComment.listComment.length == 0
