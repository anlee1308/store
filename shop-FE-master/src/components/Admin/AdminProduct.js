    ...
    <form onSubmit={onSubmitForm}>
      <div class="form-group">
        ...
        <input
          ...
          placeholder="Tiểu thuyết Phàm Nhân Tu Tiên"
        />
      </div>
      <div class="form-group">
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <button class="btn btn-secondary mb-2 ml-5" onClick={onCloseFormAdd}>
          Hủy
        </button>
      </div>
    </form>
      ...
      <div className="container">
        ...
        <div className="AdminProduct-list">
          <div class="row">
            <div class="col-12">
              {isOpenForm ? (
                <AddProduct RenderListProduct={RenderListProduct} />
              ) : (
