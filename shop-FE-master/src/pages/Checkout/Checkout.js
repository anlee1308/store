...
function Checkout() {
  ...
  function handlingFormWards() {
    ...
    if (keylocal.district != null) {
      result = Local[keylocal.city].districts[keylocal.district].wards.map(
        (district, index) => {
          return (
            <option value={district.name} data-id={index} key={index}>
              {district.name}
        ...
        <form className="payment__form" onSubmit={onHandleSubmit}>
          <div className="row justify-content-center">
            <div className="col-lg-8 text-center">
              ...
              <select
                className="cart__cupon-type-input payment__form--input"
                disabled={formPayment.thanhpho == "" ? "disabled" : null}
              ...
              <select
                className="cart__cupon-type-input payment__form--input"
                disabled={formPayment.quanhuyen == "" ? "disabled" : null}
              ...
              <div className="btn__payment_contain">
                <button className="payment__btn__submit" type="submit">
                  Thanh toán
                </button>
              </div>
            </div>
